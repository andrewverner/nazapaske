...
<div class="filter">
    <div class="block head ybg">Подбор по шинам</div>
    <div class="block content gbg">
        <div class="row">
            <form action="<?php echo Yii::app()->createUrl('tire/filter'); ?>" method="get">
                <?php foreach (WheelsTire::getFilters() as $field => $title) { ?>
                    <div class="col-lg-<?php echo $grid; ?> col-md-<?php echo $grid; ?> col-sm-<?php echo $grid; ?> col-xs-<?php echo $grid; ?> select">
                        ...
                        <select name="<?php echo $field ?>">
                            ...
                            <?php foreach (WheelsTire::getFilter($field) as $key => $val) : ?>
