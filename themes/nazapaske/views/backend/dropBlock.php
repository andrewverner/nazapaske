...
<div class="row item-card">
    ...
    <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
        ...
        Вы уверены, что хотите удалить блок "<?php echo $model->title; ?>"?<br /><br />

        <button class="btn btn-primary">Да <span class="glyphicon glyphicon-refresh" aria-hidden="true"></span></button>
        <a class="btn btn-primary-straw pull-right" href="<?php echo Yii::app()->createUrl('backend/blocks'); ?>">Нет</a>
