...
/**
 * This is the model class for table "bc_tires_alt_rear_wheels".
 *
 * The followings are the available columns in table 'bc_tires_alt_rear_wheels':
 * @property integer $id
 * @property integer $id_auto
 * @property integer $id_wheel_size
 */
class BcAlternativeDisksBack extends CActiveRecord
{
	/**
	...
	{
		return 'bc_tires_alt_rear_wheels';
	}
	 ...
	 * @return BcAlternativeDisksBack the static model class
	 */
