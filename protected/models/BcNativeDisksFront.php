...
/**
 * This is the model class for table "bc_tires_def_front_wheels".
 *
 * The followings are the available columns in table 'bc_tires_def_front_wheels':
 * @property integer $id
 * @property integer $id_auto
 * @property integer $id_wheel_size
 */
class BcNativeDisksFront extends CActiveRecord
{
	/**
	...
	{
		return 'bc_tires_def_front_wheels';
	}
	 ...
	 * @return BcNativeDisksFront the static model class
	 */
