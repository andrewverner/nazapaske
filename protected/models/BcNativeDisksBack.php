...
/**
 * This is the model class for table "bc_tires_def_rear_wheels".
 *
 * The followings are the available columns in table 'bc_tires_def_rear_wheels':
 * @property integer $id
 * @property integer $id_auto
 * @property integer $id_wheel_size
 */
class BcNativeDisksBack extends CActiveRecord
{
	/**
	...
	{
		return 'bc_tires_def_rear_wheels';
	}
	 ...
	 * @return BcNativeDisksBack the static model class
	 */
